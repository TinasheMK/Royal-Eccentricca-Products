...
export class TokenInterceptor implements HttpInterceptor {
  ...
  addTokenToHeader(request: HttpRequest<any>, token): HttpRequest<any> {
    return request.clone({ setHeaders: { Authorization: `Amrod type="integrator", token="bxnLV1Auc1nDZwquCRKHWFhMiBhXunttkmss4Fcjbl8X9dGuCQvoTPczvPRnA/s84Ujzls04siDD2dEL18dorA=="` } });
  }
